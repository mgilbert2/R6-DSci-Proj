...
ggplot(high_pick_df, aes(x = Weapon, y = Recoil)) +
  ...
  theme_minimal()
```
hmm.. finka odd one out. A high and low-rate recoil weapon. 

# Limitations
If I had quantitative statistics for the Pick Rate column that may be helpful to see a significance. The Pick Rate column is just 3 levels of category which is not descriptive enough in this case to really pull any trend out. 

Additionally for my next steps I will explore "Ban" Rates instead of pick rates to see any correlation between highly-banned operators and their weapon's recoil.